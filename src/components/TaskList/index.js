...
/**
 * Renders a list of task components recursively.
 *
 * @param {Object} taskList - The list of tasks to render.
 * @param {function} callback - The callback function to be executed on task interaction.
 * @param {function} openEditModal - The function to open the edit modal.
 * @param {function} childrenInfoGetter - The function to get children information.
 * @param {function} removeTaskAction - The function to remove a task.
 * @return {boolean} Returns false if the taskList is empty, otherwise returns JSX elements.
 */
      ...
      <div>
        <Row className="align-items-center mb-4">
          ...
          <Col xs="auto" className="ml-auto">
            <Button className="custom-button" onClick={() => this.setState({ modalMeta: { isOpen: true, taskDetails: {} } })}>+ New</Button>
          </Col>
        </Row>
